      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          ...
          <div className="flex gap-6">
            <a href="https://www.thelifeco.com/en/about-us/privacy-policy/" className="hover:text-[#01609C] transition-colors" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
